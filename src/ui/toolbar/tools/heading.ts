...
export const h1Tool: Tool = {
  type: "button",
  id: "h1",
  label: "H1",
  run: (v) => setHeading(1)(v.state, v.dispatch),
};

export const h2Tool: Tool = {
  type: "button",
  id: "h2",
  label: "H2",
  run: (v) => setHeading(2)(v.state, v.dispatch),
};

export const h3Tool: Tool = {
  type: "button",
  id: "h3",
  label: "H3",
  run: (v) => setHeading(3)(v.state, v.dispatch),
};